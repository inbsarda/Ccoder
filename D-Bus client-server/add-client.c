...
const char *const INTERFACE_NAME = "in.bhagya.dbus_example";
const char *const SERVER_BUS_NAME = "in.bhagya.add_server";
const char *const CLIENT_BUS_NAME = "in.bhagya.add_client";
const char *const SERVER_OBJECT_PATH_NAME = "/in/bhagya/adder";
const char *const CLIENT_OBJECT_PATH_NAME = "/in/bhagya/add_client";
